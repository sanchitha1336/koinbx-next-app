...
const Dashboard = () => {
  ...
  <div className="bg-white shadow-lg rounded px-8 py-6 mb-4 mt-8 border-2 border-gray-600 flex flex-col mx-10">
    ...
    <h2 className="text-lg font-semibold text-neutral-800 mb-2 text-center">Add to Hot List</h2>
    ...
    <button onClick={() => handleSubmit("hotList")} className="w-1/3 flex justify-center items-center h-10  text-center text-base text-white bg-green-500 p-4">Add</button>
    </div>
  </div>
)}
{activeTab === "newList" && (
  <div className="bg-white shadow-lg rounded px-8 py-6 mb-4 mt-8 border-2 border-gray-600 flex flex-col mx-10">
  <div className=" contents ">
    <h2 className="text-lg font-semibold mb-2 text-center">Add to New List</h2>
    <div className="mb-4 inline-flex items-start  sm:flex max-sm:flex-col ">
        <label className="mr-2 text-base text-slate-900">ProductName:</label>
      <input
        type="text"
    ...
    <button onClick={() => handleSubmit("newList")} className="w-1/3 flex justify-center items-center h-10  text-center text-base text-white bg-green-500 p-4">Add</button>
  </div>
  </div>
)}
